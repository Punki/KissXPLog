...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem1 = QtWidgets.QSpacerItem(13, 115, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem1, 12, 12, 1, 1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cb_eqsl_rcvd_new.sizePolicy().hasHeightForWidth())
        self.cb_eqsl_rcvd_new.setSizePolicy(sizePolicy)
        self.cb_eqsl_rcvd_new.setMinimumSize(QtCore.QSize(50, 22))
        self.cb_eqsl_rcvd_new.setMaximumSize(QtCore.QSize(50, 22))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cb_eqsl_sent_new.sizePolicy().hasHeightForWidth())
        self.cb_eqsl_sent_new.setSizePolicy(sizePolicy)
        self.cb_eqsl_sent_new.setMinimumSize(QtCore.QSize(50, 22))
        self.cb_eqsl_sent_new.setMaximumSize(QtCore.QSize(50, 22))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cb_lotw_rcvd_new.sizePolicy().hasHeightForWidth())
        self.cb_lotw_rcvd_new.setSizePolicy(sizePolicy)
        self.cb_lotw_rcvd_new.setMinimumSize(QtCore.QSize(50, 22))
        self.cb_lotw_rcvd_new.setMaximumSize(QtCore.QSize(50, 22))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cb_lotw_sent_new.sizePolicy().hasHeightForWidth())
        self.cb_lotw_sent_new.setSizePolicy(sizePolicy)
        self.cb_lotw_sent_new.setMinimumSize(QtCore.QSize(50, 22))
        self.cb_lotw_sent_new.setMaximumSize(QtCore.QSize(50, 22))
        ...
        self.lb_cq.setMinimumSize(QtCore.QSize(56, 22))
        self.lb_cq.setMaximumSize(QtCore.QSize(56, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.gridLayout.addItem(spacerItem3, 4, 12, 1, 1)
        ...
        self.lb_itu.setMinimumSize(QtCore.QSize(56, 22))
        self.lb_itu.setMaximumSize(QtCore.QSize(56, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.lb_comment.setMinimumSize(QtCore.QSize(65, 22))
        self.lb_comment.setMaximumSize(QtCore.QSize(65, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.le_comment.setMinimumSize(QtCore.QSize(170, 22))
        self.le_comment.setMaximumSize(QtCore.QSize(200, 22))
        ...
        self.te_notes.setMinimumSize(QtCore.QSize(170, 100))
        self.te_notes.setMaximumSize(QtCore.QSize(200, 100))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lb_filter.sizePolicy().hasHeightForWidth())
        self.lb_filter.setSizePolicy(sizePolicy)
        self.lb_filter.setMinimumSize(QtCore.QSize(60, 22))
        self.lb_filter.setMaximumSize(QtCore.QSize(60, 22))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(13, 19, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lb_filter.setText(_translate("MainWindow", "Call-Filter:"))
